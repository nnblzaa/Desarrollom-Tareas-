...
## Descripción
Usar el sensor de temperatura y arduino para medir la temperatura ambiental, al estar midiendo, pasando el umbral de temperatura que uds. Coloquen que se prenda o apague un diodo led si la temperatura pasa, por ejemplo, de 26 grados (ya vieron cómo se aumenta la temperatura); que el diodo se prenda en cuanto baje de 26; que el led se apague.                                                                                                                                                                                   
...
## Resultados
[Práctica Control de LED por temperatura con Arduino y DHT11 (1).pdf](Resultados
/Práctica Control de LED por temperatura con Arduino y DHT11 (1).pdf/Practica.Control.de.LED.por.temperatura.con.Arduino.y.DHT11.1.pdf)
